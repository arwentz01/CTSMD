...
$localIdentity=!empty($_SESSION['auth_local_identity'])&&Auth::localIdentitySwitchEnabled();$pendingAllowed=['/onboarding','/family/manage','/family-hub','/help'];if(!$localIdentity&&!Auth::isApprovedMember($currentAuthUser)&&!in_array($route,$pendingAllowed,true)){header('Location: '.($detectedBasePath?:'').'/family/manage',true,303);exit;}
