...
-- and active volunteer profile. Application signup/approval services enforce
-- eligibility before inserts; state transitions additionally re-check current
-- shift requirements. Historical states remain available for recordkeeping.
