...
final class FormBuilderIndexExperience
{
    ...
    {
        if(session_status()!==PHP_SESSION_ACTIVE)session_start();$db=Database::connect(dirname(__DIR__));$user=self::currentUser($db);if(!AccessPolicy::isStaff($user)){http_response_code(403);echo 'Restricted';exit;}
