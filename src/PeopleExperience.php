...
<?php if ($route === '/people'): ?>
<section class="people-hero page-header page-header-compact surface"><div class="page-header-main"><small class="page-header-eyebrow">STAFF WORKSPACE</small><h2 class="page-header-title">People & families</h2><p class="page-header-description">See family context before access settings. This directory is restricted to staff with People permissions.</p></div></section>
<section class="people-directory op-table" aria-label="People directory"><div class="people-directory-columns op-table-columns"><span>Name</span><span>Role</span><span>Student links</span><span>Guardian links</span><span>Action</span></div><?php foreach ($people as $person): ?><a class="people-directory-row op-table-row" href="<?= $url('/people/view?id=' . (int)$person['id']) ?>"><div class="people-directory-name op-table-primary"><i><?= $esc($person['initials']) ?></i><div><b><?= $esc($person['name']) ?></b><small><?= $esc($person['email'] ?? '') ?></small></div></div><div><span class="op-mobile-label">Role</span><?= $esc($person['role']) ?></div><div><span class="op-mobile-label">Student links</span><span class="badge badge-compact badge-neutral"><?= (int)$person['student_links'] ?></span></div><div><span class="op-mobile-label">Guardian links</span><span class="badge badge-compact badge-neutral"><?= (int)$person['guardian_links'] ?></span></div><span class="people-directory-action">Open →</span></a><?php endforeach; ?></section>
<?php else: ?>
