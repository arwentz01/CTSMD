...
final class OrganizationResourceExperience
{
    ...
    public static function render(string $route,string $basePath):never
    {
        ...
        $id=filter_input(INPUT_GET,'id',FILTER_VALIDATE_INT)?:0;$resource=$id?self::resource($db,(int)$id):null;$resources=self::resources($db);self::page($basePath,$user,$resource,$resources,$route==='/admin/member-resources/edit');
    }
