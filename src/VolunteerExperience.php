    ...
    private static function signup(PDO $db, int $userId, int $shiftId): void
    {
        ...
        try {
            ...
            if ((bool)$shift['approval_required']) {
                throw new RuntimeException('This role requires coordinator approval. Approval requests are not enabled yet.');
            }
