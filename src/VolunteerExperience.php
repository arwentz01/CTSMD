...
final class VolunteerExperience
{
    ...
    private static function shifts(PDO $db, int $userId): array
    {
        ...
        foreach ($rows as &$row) {
            ...
            $row['actionable'] = !$row['started'] && $row['requirements_met'] && !$row['approval_gate'];
