    ...
    private static function signup(PDO $db, int $userId, int $shiftId): void
    {
        ...
        try {
            ...
            if ((bool)$shift['approval_required']) {
                throw new RuntimeException('This role requires coordinator approval. Submit it through Approval requests.');
            }
